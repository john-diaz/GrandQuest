...
const reducer = function(state = initialState, action) {
  ...
  switch(action.type) {
    case 'CONNECT_USER':
      newState.connections[action.payload] = { username: 'anonymous user', authenticated: false };
      return newState;
    ...
    case 'SET_USER_AUTHENTICATED':
      newState.connections[action.payload.socketID] = { ...action.payload.user, authenticated: true };
      return newState;
    default:
      return state
  }
